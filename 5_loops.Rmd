...
This code will probably result in our fisherman catching about 25 fish, since I set the mean weight of the fish in the lake at 2lb. Technically, our fisherman might need to throw the last fish back, since it put him over the weight limit (`total_catch_lb > 50`). 
